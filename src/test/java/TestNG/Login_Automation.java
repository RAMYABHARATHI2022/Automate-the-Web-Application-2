	...
	@Test(priority = 1)
	  public void register() {
		System.setProperty("webdriver.chrome.driver","D:\\MPHASIS PHASE - 5\\chromedriver.exe");
	      ...
	      wd.findElement(By.id("ap_customer_name")).sendKeys("RAMYA");
	      //wd.findElement(By.id("ap_phone_number")).sendKeys("1234567890");
	      wd.findElement(By.id("ap_email")).sendKeys("ramya@gmail.com");
	      wd.findElement(By.id("ap_password")).sendKeys("123456");
	      wd.findElement(By.id("ap_password_check")).sendKeys("123456");
